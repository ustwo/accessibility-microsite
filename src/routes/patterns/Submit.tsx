...
export default function PatternsSubmit() {
  ...
  return (
    <Layout title="Submit a Pattern" theme="patterns" introText="Share your favorite accessibility pattern with the community. We appreciate your contributions!">
      <Helmet>
      ...
      <Section aria-labelledby="submit-heading" padding="bottom">
        <Grid>
          <Col start={1} span={6}>
