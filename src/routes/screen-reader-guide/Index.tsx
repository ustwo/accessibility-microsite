    ...
    <Layout title="Screen Reader Guide">
      ...
      <section className="content-section" aria-labelledby="guide-heading">
        <div className="container container-content">
          <h1 id="guide-heading" className="main-heading">Quick Guide to Using VoiceOver on a Mac</h1>
          
          <p className="intro-text">
            Welcome to your interactive guide for learning VoiceOver! Follow these steps and practice along to become comfortable with screen reader testing.
          </p>
